...
const componentInfo = {
    ...
    MicroSim: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.2 — Instrumenting MicroSims<br/>
    ...
    Quiz: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.3 — Quiz Statements<br/>
    ...
    Branching: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.4 — Adaptive Pathways<br/>
    ...
    ClientLib: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.5 — The Client Library<br/>
    ...
    Builder: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.6 — Building Valid Statements<br/>
    ...
    Buffer: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.7 — Batching and Offline Survival<br/>
    ...
    Retry: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.8 — Resilient Delivery<br/>
    ...
    Auth: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.9 — Authentication and Identity<br/>
    ...
    Fetch: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.10 — The Wire Format<br/>
    ...
    LRS: {
        ...
        body: `
            ...
            <p><b>Chapter section:</b> 8.11 — Inside the LRS<br/>
